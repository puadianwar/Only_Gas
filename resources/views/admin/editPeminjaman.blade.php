                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{$data->id}}" method="POST">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <select class="form-control border border-secondary form-control" name="idUser" required>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <select class="form-control border border-secondary form-control" name="kodeBuku" required>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" value="Belum Dikembalikan" @if ($data->status == 'Belum Dikembalikan') checked
                                    @endif>
                                    <label class="form-check-label" for="inlineRadio1">Belum Dikembalikan</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" value="Sudah Dikembalikan" @if ($data->status == 'Sudah Dikembalikan') checked
                                    @endif>

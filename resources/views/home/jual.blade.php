...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-success navbar-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="{{ route('logout') }}" style="text-decoration: none" class="nav-link">
    ...
    <div class="container mt-4">
        <form action="{{ route('home.jual') }}" method="GET">
            @csrf
            <div class="input-group">
                <input type="search" name="search" class="form-control rounded" placeholder="Cari Alamat Pangkalan"
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Nama Pangkalan : {{ $jual->namaPangkalan }}</h5>
                            ...
                            <a href="{{ route('home.form') }}" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Pesan Sekarang</a>
                        </div>
                    </div>
                </div>
            @endforeach
